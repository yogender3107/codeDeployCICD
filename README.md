...
```sh
git clone https://github.com/yogender3107/codeDeployCICD
```
...
2. Create Code Deploy Application.(Code Deploy -> Application)
3. Create Deployment Group.(Code Deploy -> Application -> application Name)
4. Create AWS Code pipeline for automated deployment.
